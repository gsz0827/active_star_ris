    ...
    for step in range(steps):
        ...
        if step % 100 == 0 or step == steps - 1:
            row = {
                ...
                "mean_reciprocity": float(info["mean_reciprocity"]),
                "mean_active_elements": float(info["mean_active_elements"]),
                "mean_projection_scale": float(info["mean_projection_scale"]),
